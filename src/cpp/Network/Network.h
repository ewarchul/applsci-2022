...
private:
    ...
    string periods[PERIODS_NUMBER] = {"MON", "TUE", "WED", "THU", "FRI", "SAT", "SUN"};
...
public:
    ...
    static bool check_crossroads(const MyVertex &src, const MyVertex &dst, const MyVertex &srcBis, const MyVertex &dstBis);
    static double multiplication(const MyVertex &, const MyVertex &, const MyVertex &);
    static bool lies_between(const MyVertex &, const MyVertex &, const MyVertex &);
