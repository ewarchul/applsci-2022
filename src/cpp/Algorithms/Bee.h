...
public:
    Bee(int id, const string &occupation, const vector<MyRealisation> &realisations, vector<Path> allPaths,
        bool ifCalculateRating, int initialRealisationsNumber);
    Bee(int id, const string &occupation, const vector<Car> &cars, int cost, int workerID, int initialRealisationsNumber);
    Bee();
    ...
    void generateCars(const vector<MyRealisation> &realisations, vector<Path> allPaths);
    ...
    void removeRealisation(int carIndex, int realisationIndex, const Network &network);
    ...
    void unloadCars();
    void fillTheCarsBis(const vector<MyRealisation> &real, const vector<Path> &allPaths);
    void checkCarTypes();
