...
public:
  BeeColony(int workersNumber, const vector<MyRealisation> &realisations,
  ...
  void printColony();
  int nectarHarvesting(int it, int op1Coefficient, int op2Coefficient,
                       const Country &country, bool ifCalculateRating,
